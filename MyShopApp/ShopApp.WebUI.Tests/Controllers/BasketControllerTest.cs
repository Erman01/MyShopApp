...
namespace ShopApp.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckOutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "erman@gmail.com", ZipCode = "90010" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("erman@gmail.com", "forms") ,null);
